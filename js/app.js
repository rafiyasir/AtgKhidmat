...
// }
 ...
 function altclient() {
  ...
  const client7 = document.querySelector('.client-row-7');
  if(client1.classList.contains('appear')){
    ...
    client7.classList.remove('hide');
    client7.classList.add('appear');
  }
  else if(client7.classList.contains('appear')){
    client7.classList.remove('appear');
    client7.classList.add('hide');
